...
describe('UpdateSaleUsecase Integration Test', function () {
    test('Should throws SaleNotFoundException', function () {
        $productRepository = new ProductEloquentRepository(new ModelsProduct());
        $saleRepository = new SaleEloquentRepository(new ModelsSale());
